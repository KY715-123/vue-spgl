<template>
    <div>
      ...
      <el-table size="small" :data="listData" highlight-current-row v-loading="loading" border element-loading-text="拼命加载中" style="width: 100%;">
        ...
        <el-table-column sortable prop="name" label="属性名" width="150">
        </el-table-column>
        <el-table-column sortable prop="attributeCount" label="属性数量" width="150">
        </el-table-column>
        <el-table-column sortable prop="paramCount" label="参数数量" width="150">
        </el-table-column>
      ...
      <el-dialog :title="title" :visible.sync="editFormVisible" width="30%" @click="closeDialog">
        <el-form label-width="120px" :model="editForm" :rules="rules" ref="editForm">
          ...
          <el-form-item label="属性数量" prop="attributeCount">
            <el-input size="small" type="number" v-model="editForm.attributeCount" auto-complete="off" placeholder="请输入属性数量"></el-input>
          </el-form-item>
          <el-form-item label="参数数量" prop="paramCount">
            <el-input size="small" type="number" v-model="editForm.paramCount" auto-complete="off" placeholder="请输入参数数量"></el-input>
          </el-form-item>
        </el-form>
  ...
  <script>
  import { getList,add,del, edit } from '../../api/attributeCate'
    ...
    methods: {
      ...
      handleEdit: function(index, row) {
        ...
        if (row != undefined && row != 'undefined') {
          ...
          this.editForm.attributeCount = row.attributeCount
          this.editForm.paramCount = row.paramCount
        }else {
          this.title = '添加'
          this.editForm.name = ''
          this.editForm.attributeCount = ''
          this.editForm.paramCount = ''
        }
      },
      // 编辑、增加页面保存方法
      submitForm(editData) {
